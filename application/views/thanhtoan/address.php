...
<label for="payment-address-existing">Tôi muốn sử dụng địa chỉ đã đăng ký</label>
<div id="payment-existing">
    <select name="address_id" style="width: 100%; margin-bottom: 15px;" size="5">
            <option value="104" selected="selected"><?=$address->DIACHI?></option>
    </select>
</div>
<p>
  <input type="radio" name="payment_address" value="new" id="payment-address-new" />
  <label for="payment-address-new">Tôi muốn đăng ký địa chỉ mới</label>
</p>
...
<div class="buttons">
  <div class="right">
    <input type="button" value="Tiếp tục" id="button-payment-address" class="button" />
  </div>
</div>
