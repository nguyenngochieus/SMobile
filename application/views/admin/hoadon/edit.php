        ...
        <div class="panel-body">
            ...
            <div class="col-sm-6 form-group">
                <label class="col-sm-4 control-label">Tình trạng</label>
                  <div class="col-sm-8">
                    <select id="fruits" name="tinhtrang" class="form-control ">                        
                      <option value="0" <?php if ($result->TINHTRANG == 0) { echo 'selected="selected"';} ?>>Chưa thanh toán</option> 
                      <option value="1" <?php if ($result->TINHTRANG == 1) { echo 'selected="selected"';} ?>>Đã thanh toán</option>
                    </select>
                  </div>
            </div>  
            <div class="col-sm-6">
                <div class="text-right btn-invoice">
                    ...
                    <button href="<?=base_url()?>admin/hoadon/edit?id=<?=$result->ID?>" class="btn btn-white"><i class="fa fa-edit mr5"></i>Cập nhật</button>
                </div>
            </div>
            <div class="mb40"></div>  
