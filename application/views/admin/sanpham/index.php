          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="tensanpham" class="form-control" id="tensanpham" placeholder="Điền tên sản phẩm..." required />
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="soluong" id="soluong" class="form-control" placeholder="Nhập số lượng..." required />
                  </div>
                </div>                
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="dongia" id="dongia" class="form-control" placeholder="Nhập giá..." required />
                  </div>
                </div>  
