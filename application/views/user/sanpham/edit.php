          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="tensanpham" class="form-control" id="tensanpham" value="<?= $item['TENSANPHAM']?>" placeholder="Điền tên sản phẩm..." />
                  </div>
                </div>
               <div class="form-group">
                  <label class="col-sm-2 control-label">Loại sản phẩm </label>
                  <div class="col-sm-3">
                    <select id="fruits" name="loai" class="form-control ">                      
                      <?php
                 ...
                 <div class="form-group">
                  <label class="col-sm-2 control-label">Nhà cung cấp </label>
                   <div class="col-sm-3">
                   <select id="fruits" name="nhacungcap" class="form-control " >                      
                      <?php
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="soluong" id="soluong" class="form-control" value="<?= $item['SOLUONG']?>" placeholder="Nhập số lượng..." />
                  </div>
                </div>                
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="dongia" id="dongia" class="form-control" value="<?= $item['DONGIA']?>" placeholder="Nhập giá..." />
                  </div>
                </div>  
